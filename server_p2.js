...
app.get('/display/update',(req,res) =>
{
  res.render("p.ejs");
})

app.post("dislay/update/basic", (req, res) => {
  let data = req.body;
  let id = req.body.id;
  console.log(id)
  console.log(data)
